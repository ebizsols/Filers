    ...
    <div class="portlet-body">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <x-forms.text :fieldLabel="__('modules.invoices.taxName')" fieldPlaceholder=""
                        fieldName="tax_name" fieldId="tax_name" />
                </div>

                <div class="col-sm-12 col-md-6">
                    <x-forms.text :fieldLabel="__('modules.invoices.tax')" :fieldPlaceholder="__('placeholders.invoices.gstNumber')"
                        fieldName="tax_number" fieldId="tax_number" />
                </div>
