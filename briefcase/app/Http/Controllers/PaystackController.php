...
class PaystackController extends Controller
{
    ...
    public function handleGatewayCallback($id, $type = 'invoice')
    {
        ...
        case 'invoice':
            ...
            $this->makePayment($invoice, (($paymentDetails['data']['status'] == 'success') ? 'complete' : 'failed'), $paymentDetails['data']['reference']);
        ...
        case 'order':
            ...
            if ($paymentDetails['data']['status'] == 'success') {
                ...
                $this->makePayment($invoice, 'complete', $paymentDetails['data']['reference']);
            }
    ...
    public function makePayment($invoice, $status = 'pending', $transactionId = null, $gateway = 'Paystack')
    {
