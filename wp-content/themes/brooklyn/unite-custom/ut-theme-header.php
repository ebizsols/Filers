		...
		public function create_site_logo( $class = '' ) {
			...
			<?php else :
				...
				<div class="site-logo">
					...
					<h1 class="logo <?php echo implode(' ', $logo_class ); ?>"><a href="<?php echo esc_url( apply_filters( 'ut_site_logo_url', home_url( '/' ) ) ); ?>" rel="home" <?php echo $data_logo_font_size; ?>>
		...
		public function overlay_navigation() {
			...
			<div id="ut-overlay-menu" class="ut-overlay-menu <?php echo $this->overlay_class( $copyright, $social ); ?>">
				...
				<?php if( ot_get_option( 'ut_global_overlay_logo', 'off' ) == 'text' ) : ?>
					...
					<div class="site-logo">
						<h1 class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" <?php echo $data_logo_font_size; ?>><?php bloginfo( 'name' ); ?></a></h1>
					</div>
