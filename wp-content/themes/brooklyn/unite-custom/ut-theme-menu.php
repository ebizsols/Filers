...
if( !apply_filters( 'ut_megamenu', true ) || ot_get_option( 'ut_header_layout', 'default' ) == 'side' || ot_get_option( 'ut_site_layout', 'multisite' ) == 'onepage' ) {
    return false;
}
                        ...
                        <div class="ut-field-description-color field-description-color description description-wide <?php echo $hide_extra_settings; ?>">
							<label for="edit-menu-item-description-color-<?php echo $item_id; ?>">
								...
								$field_settings = array(
									...
									'field_value' => isset( $item->description_color ) ? $item->description_color : '',
									'field_class' => ''
								);
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {            
            ...
            if( $item->object == 'navigation-widget-area' ) {
                ...
                if( $item->object == "megamenu-button" ) {
                    ...
                    $image_align  = isset( $item->megamenu_image_align ) ? $item->megamenu_image_align : 'left';
                    $image_link   = isset( $item->megamenu_image_link ) ? $item->megamenu_image_link : '';
                    $image_target = isset( $item->megamenu_image_link_target ) ? $item->megamenu_image_link_target : '_self';
