                        ...
                        foreach( $directions as $key => $direction ) {
                            ...
                            echo '<div class="grid-25">';
                                ...
                                echo '<div class="ut-numeric-slider-outer-wrap">';
                                    ...
                                    echo '<label for="' . esc_attr( $field_id ) . '-padding-' . $key . '">' . sprintf( esc_html( 'Button Padding %s', 'unitedthemes' ), $direction ) . '</label>';
                    ...
                    echo '<div id="' . esc_attr( $field_id ) . '_tab_icon">';
		                ...
		                echo '<div class="ut-numeric-slider-outer-wrap ut-single-options-wrap ut-single-options-wrap-half">';
		                    ...
		                    echo '<div class="ut-numeric-slider-wrap">';
			                    ...
			                    echo '<input data-min="0" data-max="10" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 10" value="' . ( isset( $field_value['fontawesome_v_correction_t'] ) ? esc_attr( $field_value['fontawesome_v_correction_t'] ) : '0' ) . '" autocomplete="off">';
		                ...
		                echo '<div class="ut-numeric-slider-outer-wrap ut-single-options-wrap ut-single-options-wrap-half">';
		                    ...
		                    echo '<div class="ut-numeric-slider-wrap">';
			                    ...
			                    echo '<input data-min="0" data-max="10" type="input" class="ut-ui-form-input ut-numeric-slider-helper-input" data-tooltip="' . esc_html( 'Max Value:', 'unitedthemes' ) . ' 10" value="' . ( isset( $field_value['fontawesome_v_correction_b'] ) ? esc_attr( $field_value['fontawesome_v_correction_b'] ) : '0' ) . '" autocomplete="off">';
        ...
        echo '<div class="ut-ui-select-group clearfix">';
            ...
            if( apply_filters("ot_letter_spacing_for_google_font", true, $field_id ) ) {
                ...
                echo '<div class="ut-numeric-slider-outer-wrap" style="margin-bottom:20px;">';
                    ...
                    echo '<label for="' . esc_attr( $field_id ) . '-letter-spacing">' . esc_html( 'Letter Spacing', 'unitedthemes' ) . '</label>';
            ...
            if ( in_array( 'letter-spacing', $ot_recognized_typography_fields ) ) {
                ...
                if( apply_filters("ot_letter_spacing_option_type", "numeric", $field_id ) == "default" ) {
                    ...
                    echo '<div class="ut-numeric-slider-outer-wrap" style="margin-bottom:20px;">';
                        ...
                        echo '<label for="' . esc_attr( $field_id ) . '-letter-spacing">' . esc_html( 'Letter Spacing', 'unitedthemes' ) . ' in EM</label>';
    ...
    function ot_type_border( $args = array() ) {
        ...
        foreach( $directions as $key => $direction ) {
            ...
            echo '<div class="' . $fields_grid . '">';
                ...
                echo '<label>' . sprintf( esc_html( 'Border %s Color', 'unitedthemes' ), $direction ) . '</label>';
            ...
            if( in_array( 'border-style', $ut_recognized_border_fields ) )  {
                ...
                echo '<div class="' . $fields_grid . '">';
                    ...
                    echo '<div class="ut-ui-select-field">';
                        ...
                        echo '<label>' . sprintf( esc_html( 'Border %s Style', 'unitedthemes' ), $direction ) . '</label>';
            ...
            if( in_array( 'border-width', $ut_recognized_border_fields ) )  {
                ...
                echo '<div class="' . $fields_grid . '">';
                    ...
                    echo '<div class="ut-numeric-slider-outer-wrap">';
                        ...
                        echo '<label for="' . esc_attr( $field_id ) . '-border-' . $key . '-width">' . sprintf( esc_html( 'Border %s Width', 'unitedthemes' ), $direction ) . '</label>';
            ...
            if( in_array( 'padding', $ut_recognized_border_fields ) )  {
                ...
                echo '<div class="' . $fields_grid . '">';
                    ...
                    echo '<div class="ut-numeric-slider-outer-wrap">';
                        ...
                        echo '<label for="' . esc_attr( $field_id ) . '-padding-' . $key . '">' . sprintf( esc_html( 'Padding %s', 'unitedthemes' ), $direction ) . '</label>';
    ...
    function ot_type_frame( $args = array() ) {
        ...
        foreach( $directions as $key => $direction ) {
            ...
            echo '<div class="ut-ui-select-field">';
                ...
                echo '<label>' . sprintf( esc_html( 'Show %s Frame', 'unitedthemes' ), $direction ) . '</label>';
