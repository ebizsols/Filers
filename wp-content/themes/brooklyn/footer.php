						...
						<header class="csection-title <?php echo $ut_csection_title_style; ?>-header <?php echo $ut_csection_header_style; ?> ut-no-lead-linebreak-mobile">
							...
							<?php if( !empty( $ut_csection_header_slogan ) ) : ?>
								...
								<?php if( $ut_csection_header_style == 'pt-style-1' ) : ?>
									...
									<h2 data-title="<?php echo esc_attr( $ut_data_csection_header_slogan ); ?>" class="bklyn-divider-styles bklyn-divider-style-1 <?php echo $ut_csection_title_style; ?>-title <?php echo implode(" ", $csection_title_classes );?>">
                                        <span><?php echo do_shortcode( nl2br( $ut_csection_header_slogan ) ); ?></span>
                                    </h2>

								<?php else : ?>

                                    <h2 data-title="<?php echo esc_attr( $ut_data_csection_header_slogan ); ?>" class="<?php echo ot_get_option('ut_csection_parallax' , 'off') == 'off' ? 'section-title' : 'parallax-title'; ?> <?php echo implode(" ", $csection_title_classes );?>">
