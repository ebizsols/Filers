;(function($){
    ...
    window.wait_for_reveal = function( selector, callback ) {
        ...
        window.reveal_wait[selector] = setInterval( function() {
            ...
            if( $(selector).parent().hasClass('ut-element-revealer-ready') ) {
    ...
    var ut_video_observer = lozad('.ut-lazy-video', {
        threshold: 0.1,
        loaded: function(el) {
    ...
    $(document).ready(function(){
        ...
        function init_selfhosted_video_player() {
